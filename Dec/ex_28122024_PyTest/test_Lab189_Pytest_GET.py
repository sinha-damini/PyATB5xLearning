...
@allure.title("TC01 - Verify the GET Request of Restful Booker")
@allure.description("This Testcase check BookingId 1 and verify the response")
...
@allure.title("TC02 - Verify the GET Request of Restful Booker with invalid ID")
@allure.description("This Testcase check BookingId -1 and verify the response")
@pytest.mark.positive
